...
class BagsStoreScreen extends StatelessWidget {
  const BagsStoreScreen({Key? key}) : super(key: key);
  static const String id = 'BagsStoreScreen';
  @override
              ...
              children: [
                ...
                Expanded(
                  child: GridView.builder(
                    ...
                    itemCount: model.bagsCount,
                    itemBuilder: (_, index) {
                      var bag = model.bags[index];
                      return ProductCard(
